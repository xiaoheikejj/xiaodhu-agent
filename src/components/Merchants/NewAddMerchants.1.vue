<template lang="html">
    <div id="NewAddMerchants" style="width:100%;">
        ...
        <div class="company-form-box">
          <el-form class="company-form" ref="companyForm" :model="companyForm" label-width="240px">
            ...
            <el-form-item label="资料上传：">
              <el-upload
                action="http://192.168.1.251:8080/upload/fileupload"
                ref="upload"
...
export default {
    ...
    methods:{
      ...
      submit(){
        ...
        let mercBusinessLicensePic = path;
        let provinceName = '';
        let industryName = '';
      ...
      selectProvince(item){
        ...
        commonAjax('/areacode/getCity', 'post', paramsForm).then(res => {
          this.cityArr = res;
          this.companyForm.name3 = this.cityArr[0]['areaName'];
        });
      },
      selectCity(){
